        ...
        <ScrollView
          ...
          <View style={styles.carousel}>
            <View
              ...
              <View
                style={[
                  ...
                  {backgroundColor: 'transparent', gap: 10, paddingTop: 0},
                ]}>
                <TouchableOpacity
                  style={{
                    paddingHorizontal: 15,
            ...
            <View
              ...
              <View style={{padding: 5}}>
                <Text
                  style={[
                    styles.counterItem,
                    {borderRightWidth: 1, borderColor: '256994'},
                  ]}>
                  130
                </Text>
            ...
            <View
              ...
              <View>
                <Text style={[styles.counterItem, {fontSize: 22}]}>
                  259,000
                </Text>
                <View
                  style={{
                  ...
                  <Text style={[styles.textHeadingCounter, {paddingTop: 0}]}>
                    {' '}
                    Income{' '}
                  </Text>
                  <View
                    ...
                    <Image
                      ...
                      source={require('../../images/iconImage.png')}
                    />
          ...
          <TouchableOpacity onPress={() => navigation.navigate('PatientList')}>
            <View style={styles.thirdchild}>
              <View style={styles.thirdchildOne}>
                ...
                />
                <Text style={styles.headingMian}>{!isNurse?'Apointment List':"Assigned Apoinment"}</Text>
              ...
              <View style={{width: '50%'}}>
                <Image
                  ...
                  source={require('../../images/patinet.png')}
                />
              </View>
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.fourthChild}>
            ...
            {!isNurse?<View style={styles.fourthChildTwo}>
              <View>
