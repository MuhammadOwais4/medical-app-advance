    ...
    <View style={styles.top}>
      <View style={styles.topOne}>
        <View style={styles.topOneOne}>
          {/* <View style={{backgroundColor:'256994',padding:10,borderRadius:50}}>
        ...
        <TouchableOpacity style={{backgroundColor:'256994',padding:10,borderRadius:50}} onPress={()=>navigation.navigate('Notification')} >
          ...
          <TouchableOpacity style={{backgroundColor:'256994',padding:10,borderRadius:50}} onPress={showLogoutModal}>
