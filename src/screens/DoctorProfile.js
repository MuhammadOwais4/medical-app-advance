  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={[styles.button, { backgroundColor: '256994' }]} onPress={() => navigation.navigate("DoctorProfileEdit",{image:data.image,name:data.name,location:data.location})}>
