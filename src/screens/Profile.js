    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.counterContainer}>
        <View style={{ padding: 5 }}>
          <Text style={[styles.counterItem, { borderRightWidth: 1, borderColor: '256994' }]}>130</Text>
          <Text style={styles.textHeadingCounter}>Appointments</Text>
        </View>
        <View style={{ padding: 5 }}>
          <Text style={[styles.counterItem, { borderRightWidth: 1, borderColor: '256994' }]}>30</Text>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={[styles.button, { backgroundColor: '256994' }]} onPress={() => navigation.navigate("PatientProfileEdit",{image:data.image,name:data.name,location:data.location})}>
